...
//   // Webhook URL
//   const WEBHOOK_URL = 'https://n8n.srv915056.hstgr.cloud/webhook-test/socialmediadata';
...
const SocialMediaForm = ({ onBack }) => {
  ...
  // Webhook URL
  const WEBHOOK_URL = 'https://n8n.srv915056.hstgr.cloud/webhook/socialmediadata';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('📥 RESPONSE DATA RECEIVED FROM WEBHOOK:', responseData);
        ...
        if (Array.isArray(responseData)) {
          ...
          console.log('🔍 Sample result (first item):', responseData[0]);
          ...
          console.log('🗝️ All unique keys in response data:', Array.from(allKeys));
        }
